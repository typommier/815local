...
// Injects title/meta/JSON-LD for crawlers. Do not redirect away from this page.
...
export async function onRequest(context) {
  ...
  const desc = biz.description
    ...
    : ((biz.category || 'Local business') + ' in the 815 area, find hours and contact info on 815local.');
